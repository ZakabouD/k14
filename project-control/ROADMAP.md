...
| Supported Pi Runtime Qualification | Qualify supported Node runtime on ARM64 Pi | NEXT / Pending | Formal physical qualification of Node.js 22 LTS on ARM64 Raspberry Pi OS Lite (64-bit) / Debian 12 Bookworm to replace EOL Node 20.20.2 baseline; required before Client #1. |
...
| Client #1 | Real-client security closure and onboarding | NOT AUTHORIZED / Conditional | Blocked by Supported Pi Runtime Qualification and D7 Admin Credential Closure. Complete client intake, HR/privacy/biometric/legal responsibilities, backup/DR/acceptance and handover under explicit deployment authorization. |
